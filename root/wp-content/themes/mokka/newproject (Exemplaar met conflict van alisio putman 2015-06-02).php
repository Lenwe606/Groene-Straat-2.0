    ...
    <div id="content">
        <form id="new" method="post">
            ...
            <section id="field">
                ...
                <p><input type="text" placeholder="<?php echo $project_location; ?>" id="location" name="location"
                          required/></p>
                <select id="cboCategory" name="category" class="cbo">
                    <?php echo project_category_options(get_project_category()); ?>
                </select>
                <textarea placeholder="<?php echo $project_description; ?>" id="description" name="description"
                          required></textarea>
            ...
            <div id="formButton">
                <p>
                    <button type="reset" value="<?php echo $reset; ?>"><?php echo $reset; ?></button>
                </p>
