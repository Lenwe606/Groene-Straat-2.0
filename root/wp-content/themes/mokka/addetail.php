...
<div id="wrapper">
	<div id="content">
		...
		if(!empty($_GET["id"])){
			...
			<script lang="javascript">window.location = "./index.php?page=ads";</script>
			<?php
			}
			else
			{
        ...
        <section class="buttons">
            <?php if($project_owner) {?>
                <a href="./index.php?page=newadd&id=<?php echo $_GET["id"]; ?>"><button value="<?php echo $detail_edit; ?>"><?php echo $detail_edit; ?></button></a>
